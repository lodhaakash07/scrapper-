...
def main():
    ...
    i = 0
    lst=[]
    save_path = "~/pro_candice/images/flipkart/cropped_fltops/"
    ...
    for item in json_data:
        ...
        try:
            ...
            localfile = open('~/pro_candice/images/flipkart/cropped_fltops/'+'fl_00_tp'+str(i)+'.jpg', 'wb')
    ...
    try:
        with open('~/pro_candice/images/flipkart/cropped_fltops/flipkart_localimg_tops.json', 'w') as outfile:
