...
def main():
    ...
    i = 0
    lst=[]
    save_path = "~/pro_candice/images/jabong/cropped_jbags/"
    ...
    for item in json_data:
        ...
        try:
            ...
            localfile = open('~/pro_candice/images/jabong/cropped_jbags/'+'ja_00_bg'+str(i)+'.jpg', 'wb')
    ...
    try:
        with open('~/pro_candice/images/jabong/cropped_jbags/jab_localimg_bags.json', 'w') as outfile:
