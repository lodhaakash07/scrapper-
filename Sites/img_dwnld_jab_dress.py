...
def main():
    ...
    i = 0
    lst=[]
    save_path = "~/pro_candice/images/jabong/cropped_jdress/"
    ...
    for item in json_data:
        ...
        try:
            ...
            localfile = open('~/pro_candice/images/jabong/cropped_jdress/'+'ja_00_dr'+str(i)+'.jpg', 'wb')
    ...
    try:
        with open('~/pro_candice/images/jabong/cropped_jdress/jab_localimg_dress.json', 'w') as outfile:
