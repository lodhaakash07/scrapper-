...
def main():
    ...
    i = 0
    lst=[]
    save_path = "~/pro_candice/images/koovs/cropped_kbags/"
    ...
    for item in json_data:
        ...
        try:
            ...
            localfile = open('~/pro_candice/images/koovs/cropped_kbags/'+'kv_00_bg'+str(i)+'.jpg', 'wb')
    ...
    try:
        with open('~/pro_candice/images/koovs/cropped_kbags/koovs_localimg_bags.json', 'w') as outfile:
