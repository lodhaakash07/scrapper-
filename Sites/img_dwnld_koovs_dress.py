...
def main():
    ...
    i = 0
    lst=[]
    save_path = "~/pro_candice/images/koovs/cropped_kdress/"
    ...
    for item in json_data:
        ...
        try:
            ...
            localfile = open('~/pro_candice/images/koovs/cropped_kdress/'+'kv_00_dr'+str(i)+'.jpg', 'wb')
    ...
    try:
        with open('~/pro_candice/images/koovs/cropped_kdress/koovs_localimg_dress.json', 'w') as outfile:
