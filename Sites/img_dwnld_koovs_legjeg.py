...
def main():
    ...
    i = 0
    lst=[]
    save_path = "~/pro_candice/images/koovs/cropped_klegjeg/"
    ...
    for item in json_data:
        ...
        try:
            ...
            localfile = open('~/pro_candice/images/koovs/cropped_klegjeg/'+'kv_00_lj'+str(i)+'.jpg', 'wb')
    ...
    try:
        with open('~/pro_candice/images/koovs/cropped_klegjeg/koovs_localimg_legjeg.json', 'w') as outfile:
