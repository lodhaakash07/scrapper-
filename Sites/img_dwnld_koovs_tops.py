...
def main():
    ...
    i = 0
    lst=[]
    save_path = "~/pro_candice/images/koovs/cropped_ktops/"
    ...
    for item in json_data:
        ...
        try:
            ...
            localfile = open('~/pro_candice/images/koovs/cropped_ktops/'+'kv_00_tp'+str(i)+'.jpg', 'wb')
    ...
    try:
        with open('~/pro_candice/images/koovs/cropped_ktops/koovs_localimg_tops.json', 'w') as outfile:
