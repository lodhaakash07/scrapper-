...
def main():
    ...
    i = 0
    lst=[]
    save_path = "~/pro_candice/images/myntra/cropped_mbags/"
    ...
    for item in json_data:
        ...
        try:
            ...
            localfile = open('~/pro_candice/images/myntra/cropped_mbags/'+'myn_00_bg'+str(i)+'.jpg', 'wb')
    ...
    try:
        with open('~/pro_candice/images/myntra/cropped_mbags/myn_localimg_bags.json', 'w') as outfile:
