...
def main():
    ...
    i = 0
    lst=[]
    save_path = "~/pro_candice/images/myntra/cropped_mdress/"
    ...
    for item in json_data:
        ...
        try:
            ...
            localfile = open('~/pro_candice/images/myntra/cropped_mdress/'+'myn_00_dr'+str(i)+'.jpg', 'wb')
    ...
    try:
        with open('~/pro_candice/images/myntra/cropped_mdress/myn_localimg_dress.json', 'w') as outfile:
