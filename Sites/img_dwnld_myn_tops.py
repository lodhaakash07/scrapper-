...
def main():
    ...
    i = 0
    lst=[]
    save_path = "~/pro_candice/images/myntra/cropped_mtops/"
    ...
    for item in json_data:
        ...
        try:
            ...
            localfile = open('~/pro_candice/images/myntra/cropped_mtops/'+'myn_00_tp'+str(i)+'.jpg', 'wb')
    ...
    try:
        with open('~/pro_candice/images/myntra/cropped_mtops/myn_localimg_tops.json', 'w') as outfile:
