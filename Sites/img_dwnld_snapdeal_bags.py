...
def main():
    ...
    i = 0
    lst=[]
    save_path = "~/pro_candice/images/snapdeal/cropped_sbags/"
    ...
    for item in json_data:
        ...
        try:
            ...
            localfile = open('~/pro_candice/images/snapdeal/cropped_sbags/'+'sd_00_bg'+str(i)+'.jpg', 'wb')
    ...
    try:
        with open('~/pro_candice/images/snapdeal/cropped_sbags/sd_localimg_bags.json', 'w') as outfile:
