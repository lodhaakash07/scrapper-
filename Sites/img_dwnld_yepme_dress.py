...
def main():
    ...
    i = 0
    lst=[]
    save_path = "~/pro_candice/images/yepme/cropped_ydress/"
    ...
    for item in json_data:
        ...
        try:
            ...
            localfile = open('~/pro_candice/images/yepme/cropped_ydress/'+'yp_00_dr'+str(i)+'.jpg', 'wb')
    ...
    try:
        with open('~/pro_candice/images/yepme/cropped_ydress/yp_localimg_dress.json', 'w') as outfile:
