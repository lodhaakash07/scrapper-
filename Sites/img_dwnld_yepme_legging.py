...
def main():
    ...
    i = 0
    lst=[]
    save_path = "~/pro_candice/images/yepme/cropped_ylegging/"
    ...
    for item in json_data:
        ...
        try:
            ...
            localfile = open('~/pro_candice/images/yepme/cropped_ylegging/'+'yp_00_lj'+str(i)+'.jpg', 'wb')
    ...
    try:
        with open('~/pro_candice/images/yepme/cropped_ylegging/yp_localimg_legging.json', 'w') as outfile:
