...
def main():
    ...
    i = 0
    lst=[]
    save_path = "~/pro_candice/images/yepme/cropped_ytops/"
    ...
    for item in json_data:
        ...
        try:
            ...
            localfile = open('~/pro_candice/images/yepme/cropped_ytops/'+'yp_00_tp'+str(i)+'.jpg', 'wb')
    ...
    try:
        with open('~/pro_candice/images/yepme/cropped_ydress/yp_localimg_tops.json', 'w') as outfile:
