...
def main():
    ...
    i = 0
    lst=[]
    save_path = "~/pro_candice/images/zovi/cropped_zdress/"
    ...
    for item in json_data:
        ...
        try:
            ...
            localfile = open('~/pro_candice/images/zovi/cropped_zdress/'+'zv_00_dr'+str(i)+'.jpg', 'wb')
    ...
    try:
        with open('~/pro_candice/images/zovi/cropped_zdress/zovi_localimg_dress.json', 'w') as outfile:
