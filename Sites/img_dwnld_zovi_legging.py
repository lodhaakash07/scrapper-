...
def main():
    ...
    i = 0
    lst=[]
    save_path = "~/pro_candice/images/zovi/cropped_zlegjeg/"
    ...
    for item in json_data:
        ...
        try:
            ...
            localfile = open('~/pro_candice/images/zovi/cropped_zlegjeg/'+'zv_00_lj'+str(i)+'.jpg', 'wb')
    ...
    try:
        with open('~/pro_candice/images/zovi/cropped_zlegjeg/zovi_localimg_legjeg.json', 'w') as outfile:
