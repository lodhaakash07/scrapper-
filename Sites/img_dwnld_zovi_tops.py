...
def main():
    ...
    i = 0
    lst=[]
    save_path = "~/pro_candice/images/zovi/cropped_ztops/"
    ...
    for item in json_data:
        ...
        try:
            ...
            localfile = open('~/pro_candice/images/zovi/cropped_ztops/'+'zv_00_tp'+str(i)+'.jpg', 'wb')
    ...
    try:
        with open('~/pro_candice/images/zovi/cropped_ztops/zovi_localimg_tops.json', 'w') as outfile:
