...
class FashionaraHandbags(Spider):
    name = "fashionara_handbags"
    allowed_domains = ["fashionara.com"]
    start_urls = [
        "http://www.fashionara.com/ladies/bags/handbags.html#!dir=desc&product=HANDBAG&sort=new_bestselling"
    ]
