...
class FlipkartTops(Spider):
    name = "flipkart_tops"
    allowed_domains = ["flipkart.com"]
    start_urls = [
        "http://www.flipkart.com/womens-clothing/shirts-tops-tunics/tops/pr?sid=2oq%2Cc1r%2Ccck%2C2gs&ref=106dd849-9067-4c0e-97d7-14014cd1516a"
    ]
